<?php $data = $this->crud_model->get_credits(); $moneda = $this->crud_model->get_info("moneda");?>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Ventas al crédito
                            <span class="d-block text-muted pt-2 font-size-sm">Consulta el historial de tus ventas al
                                crédito.</span>
                        </h3>
                    </div>
                    <?php if($data->num_rows() > 0 && ($user_type == 1 || $permisos['reportes_creditos'] == 1)):?>
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <ul class="navi flex-column navi-hover py-2">
                                    <li
                                        ...
                                        Exportar como:</li>
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_excel/creditos';?>"
                                            class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_pdf/creditos';?>"
                                            class="navi-link">
                                            <span class="navi-icon">
                        ...
                        <table class="table table-bordered dataTable no-footer dtr-inline" id="kt_datatable">
                            ...
                            <tbody id='table'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="label label-lg font-weight-bold label-light-<?php if($row['estado'] == 1){ echo 'warning';}elseif($row['estado'] == 2){echo 'success';}elseif($row['estado'] == 3){echo 'danger';}?> label-inline">
                                            <?php if($row['estado'] == 1){ echo 'Crédito'; }elseif($row['estado'] == 2){ echo 'Completados' ; }elseif($row['estado'] == 3){echo 'Anulado';} ?>
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        <?php $tl = $row['total']-$row['total_pagado']; echo $moneda.number_format($tl,2,'.',',');?>
                                    </td>
                                    <td>
                                        ...
                                        <div class="d-flex flex-shrink-0">
                                            ...
                                            <a href="<?php echo base_url().'admin/detalles_credito/'.$row['code'];?>"
                                            ...
                                            <a href="<?php echo base_url().'admin/export_pdf/credito/'.$row['code'];?>"
                                            ...
                                            <?php endif;?>
                                            &nbsp;
                                            <?php if($user_type == 1 || $permisos['eliminar_creditos'] == 1):?>
