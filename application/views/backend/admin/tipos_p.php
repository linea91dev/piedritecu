            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Gestionar tipos de productos
                            <span class="d-block text-muted pt-2 font-size-sm">Administra tus tipos de productos.</span>
                        </h3>
                    </div>
                    <div class="card-toolbar">

                        <?php $types = $this->crud_model->get_types_product();
                        ...
                        <table class="table table-bordered dataTable no-footer dtr-inline" id="kt_datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" onclick="showModalProductos('<?php echo base_url().'modal/popup/modal_productos_tipo/'.base64_encode($row['type_product_id']);?>')">
                                        <span
                                            class="label label-lg font-weight-bold label-light-info label-inline"><?php echo count($this->db->get_where('products', array('type_product_id' => $row['type_product_id'], 'status' => 1))->result_array());?>
                                        </span>
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex flex-shrink-0">
                                            ...
                                            <a href="javascript:void(0);"
                                                onclick="showAjaxModal('<?php echo base_url();?>modal/popup/editar_tipo_producto/<?php echo $row['type_product_id'];?>');"
                                            ...
                                            <a href="javascript:void(0);"
                                                onclick="executeExample('<?php echo $row['type_product_id'];?>')"
...
<div class="modal fade" id="exampleModalSizeLg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-dialog  modal-lg">
            ...
            <form class="form" action="<?php echo base_url()?>admin/tipos_p/create" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" required="" name="name_type" class="form-control"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control" name="description_type"
...
function executeExample(admin_id) {
    Swal.fire({
        ...
        if (result.value) {
            ...
            location.href = "<?php echo base_url();?>admin/tipos_p/delete/" + admin_id;
        }
    })
}
</script>