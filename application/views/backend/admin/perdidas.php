<?php $data = $this->crud_model->get_losses_products($initial, $final); 
    $total = $this->crud_model->get_losses_total($initial, $final);
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <ul class="navi flex-column navi-hover py-2">
                                    <li class="navi-header font-weight-bolder text-uppercase font-size-sm text-primary pb-2">
                                        Exportar como:</li>
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_excel/perdidas_detalles_fechas/'.$initial.'/'.$final.'/';?>" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="la la-file-excel-o"></i>
                                            </span>
                                            <span class="navi-text">Pérdidas por fechas</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <a href="<?php echo base_url();?>admin/registrar_perdida/" class="btn btn-info font-weight-bolder ml-2">
                            <span class="svg-icon svg-icon-md">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
                            ...
                            </span>Registrar perdidas
                        </a>
                        <?php endif;?>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?php echo base_url();?>admin/perdidas/">
                        <div class="row">
                            <div class="col-sm-3">
...
<script type="text/javascript" language="javascript" >  
    $(document).ready(function(){  
      var dataTable = $('#user_data').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'admin/get_perdidas/'.$initial.'/'.$final.'/'; ?>",  
                type:"POST"  
           },   
        });  
    });  
