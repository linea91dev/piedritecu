<?php $moneda = $this->crud_model->get_info("moneda"); setlocale(LC_TIME, "spanish");
    ...
    $data = $this->crud_model->get_totals_sales_marks($initial, $final, $mark_id);
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <form action="<?php echo base_url();?>admin/ventas_marca/" method="POST">
                        <div class="row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="mark_id" id="selected-1">
                                            <option value="T">Todas</option>
                                            <?php $marcas = $this->crud_model->get_mark(); 
                                                foreach ($marcas->result_array() as $mk):?>
                                            <option value="<?php echo $mk['mark_id'];?>" <?php if($mk['mark_id'] == $mark_id) echo "selected";?>><?php echo $mk['name'];?>
                                            </option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                            <div class="card-title">
                                <h3 class="card-label">Ventas por marca</h3>
                            </div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <ul class="navi flex-column navi-hover py-2">
                                            <li
                                                ...
                                                Exportar como:</li>
                                            <li class="navi-item">
                                                <a href="<?php echo base_url().'admin/export_excel/ventas_marca/'.$initial.'/'.$final.'/'.$mark_id.'/';?>"
                                                    class="navi-link">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "<?php echo base_url() . 'admin/get_ventas_marca/'.$initial.'/'.$final.'/'.$mark_id; ?>",
            type: "POST"
        },
