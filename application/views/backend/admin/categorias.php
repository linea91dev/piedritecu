            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Gestionar categorías
                            <span class="d-block text-muted pt-2 font-size-sm">Administra tus categorías de
                                productos.</span>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        ...
                        <?php $categories = $this->crud_model->get_categories();
							...
							if($categories->num_rows() > 0 && ($user_type == 1 || $permisos['reportes_categorias'] == 1)):?>
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <ul class="navi flex-column navi-hover py-2">
                                    <li
                                        ...
                                        Exportar como:</li>
                                    <li class="navi-item">
                                        <a href="<?php echo base_url()?>admin/export_excel/categories"
                                            class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="<?php echo base_url()?>admin/export_pdf/categories" class="navi-link">
                                            <span class="navi-icon">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered dataTable no-footer dtr-inline" id="kt_datatable">
                            ...
                            <tbody>
                                <?php $n =1; foreach($categories->result_array() as $row): ?>
                                <tr>
                                    <td><?php echo $n++;?></td>
                                    <td><?php echo $row['name'];?></td>
                                    <td>
                                        <a href="javascript:void(0);" onclick="showModalProductos('<?php echo base_url().'modal/popup/modal_productos_categoria/'.base64_encode($row['category_id']);?>')">
                                            <span class="label label-lg font-weight-bold label-light-info label-inline"><?php echo count($this->db->get_where('products', array('category' => $row['category_id'], 'status' => 1))->result_array());?></span>
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex flex-shrink-0">
                                            ...
                                            <a href="javascript:void(0);"
                                                onclick="showAjaxModal('<?php echo base_url();?>modal/popup/editar_categoria/<?php echo $row['category_id'];?>');"
                                            ...
                                            <a href="javascript:void(0);"
                                                onclick="executeExample('<?php echo $row['category_id'];?>')"
...
<div class="modal fade" id="exampleModalSizeLg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-dialog  modal-lg">
            ...
            <form class="form" action="<?php echo base_url()?>admin/categorias/create" method="POST">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" required="" name="name_category" class="form-control"
...
function executeExample(admin_id) {
    Swal.fire({
        ...
        if (result.value) {
            ...
            location.href = "<?php echo base_url();?>admin/categorias/delete/" + admin_id;
        }
    })
}
</script>