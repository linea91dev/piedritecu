<?php 
    ...
    $ingresos = $this->crud_model->ingresos_caja_date($initial);
    $ingresos_credito = $this->crud_model->ingresos_credito_date($initial);
    $egresos = $this->crud_model->egresos_caja_date($initial);
    $transaccion= $this->crud_model->total_transf_date($initial);
    $total_tarjeta= $this->crud_model->total_tarjeta_date($initial);
    $caja = $this->crud_model->total_caja();
    $total_compras= $this->crud_model->total_compras_date($initial);
    $total_compras_creditos = $this->crud_model->total_compras_creditos($initial);
?>
        ...
        <div class="col-xl-12">
            <div class="card card-custom">
                ...
                <div class="card-body">
                       ...
                       <form method="POST" action="<?php echo base_url().'admin/corte_caja_filtro/'?>">
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-2">
                                    <input type="submit" style="margin-top:35px" class="btn btn-rounded btn-success" value="Filtrar" />
                                </div>
                            </div>
                        </form>
                        <form class="form" action="<?php echo base_url().'admin/create_box_cut/';?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="caja_actual" value="<?php echo $caja;?>" step="0.01" class="form-control"aria-label="Text input with checkbox" readonly="true">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="card card-custom gutter-b">
                                            <div class="card-body d- flex f lex-column">
                                                <div class="d-f lex align-ite ms-center justify-con tent -between flex-g row-1">
                                                    <div class="mr-2">
                                                        <h3 class="font-weight-bolder">Total Transferencias:</h3>
                                                    </div>
                                        ...
                                        <input type="hidden" name="monto_limite" value="<?php echo $monto_limite;?>" step="0.01" class="form-control" aria-label="Text input with checkbox" readonly="true">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="card card-custom gutter-b">
                                            <div class="card-body d- flex f lex-column">
                                                <div class="d-f lex align-ite ms-center justify-con tent -between flex-g row-1">
                                                    <div class="mr-2">
                                                        <h3 class="font-weight-bolder">Total Tarjeta:</h3>
                                                    </div>
                                                    <div class="font-weight-boldest font-size-h1 text-warning">
                                                        <?php echo $moneda.number_format($total_tarjeta,2,'.',',');?></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="card card-custom gutter-b">
                                            <div class="card-body d- flex f lex-column">
                                                <div class="d-f lex align-ite ms-center justify-con tent -between flex-g row-1">
                                                    <div class="mr-2">
                                                        <h3 class="font-weight-bolder">Total ventas al crédito:</h3>
                                                    </div>
                                                    <div class="font-weight-boldest font-size-h1 text-success">
                                                        <?php if ($ingresos_credito > 0) echo $moneda.number_format($ingresos_credito,2,'.',','); else echo $moneda.'0.00'; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <input type="hidden" id="ingresos" name="ingresos"
                                            value="<?php if ($ingresos_credito > 0) echo $ingresos_credito; else echo 0; ?>" step="0.01"
                                            class="form-control" aria-label="Text input with checkbox" readonly="true">
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-custom gutter-b">
                                            <div class="card-body d- flex f lex-column">
                                                <div class="d-f lex align-ite ms-center justify-con tent -between flex-g row-1">
                                                    ...
                                                    <?php if($this->session->userdata('branch_id')=='1'): ?><span>(Total con compras: <?php echo $moneda.number_format($ingresos-$total_compras,2,'.',',') ?>)</span> <?php  endif;?>
                                                </div>
                                            </div>
                                        </div>
                                        <input type="hidden" id="ingresos" name="ingresos"
                                ...
                                <?php if($this->session->userdata('branch_id')== 1 ):?>
                                        ...
                                        <div class="form-group">
                                            <div class="card card-custom gutter-b">
                                                <div class="card-body d- flex f lex-column">
                                                    <div class="d-f lex align-ite ms-center justify-con tent -between flex-g row-1">
                                                        <div class="mr-2">
                                                            <h3 class="font-weight-bolder">Total Compras:</h3>
                                                        </div>
                                                        <div class="font-weight-boldest font-size-h1 text-danger">
                                                            <?php echo $moneda.number_format($total_compras,2,'.',',');?></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="hidden" name="monto_limite" value="<?php echo $monto_limite;?>" step="0.01"
                                        ...
                                        <div class="form-group">
                                            <div class="card card-custom gutter-b">
                                                <div class="card-body d- flex f lex-column">
                                                    <div class="d-f lex align-ite ms-center justify-con tent -between flex-g row-1">
                                                        <div class="mr-2">
                                                            <h3 class="font-weight-bolder">Total pago a proveedores :</h3>
                                                        </div>
                                                        <div class="font-weight-boldest font-size-h1 text-danger">
                                                            <?php echo $moneda.number_format($total_compras_creditos,2,'.',',');?></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="hidden" name="monto_limite" value="<?php echo $monto_limite;?>" step="0.01"
                                    ...
                                    <?php $esperado =  (($ingresos+$transaccion+$total_tarjeta)-($total_compras+$total_compras_creditos));?>
                                    <?php else:?>
                                    <?php $esperado =  (($ingresos+$transaccion+$total_tarjeta));?>
                                    <?php endif;?>
                                <?php $diferencia = $ingresos - $egresos;?>
                                <input type="hidden" name="diferencia_day" step="0.01" value="<?php echo $diferencia; ?>" class="form-control" aria-label="Text input with checkbox" readonly="true">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="card card-custom gutter-b">
                                            <div class="card-body d- flex f lex-column">
                                        ...
                                        <input type="hidden" name="caja_nueva" id="caja_nueva" step="0.01" value="<?php echo $esperado; ?>" class="form-control" aria-label="Text input with checkbox" readonly="true">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
...
<script type="text/javascript" language="javascript" >  
    $(document).ready(function(){  
      var dataTable = $('#user_data').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'admin/get_increase/'.$initial.'/'.$final.'/'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
