<?php $moneda = $this->crud_model->get_info("moneda"); setlocale(LC_TIME, "spanish");
    $data = $this->crud_model->get_totals_sales_seller($initial, $final, $vendedor_id);
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <form action="<?php echo base_url();?>admin/ventas_vendedor/" method="POST">
                        <div class="row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="vendedor_id" id="selected-1">
                                            <option value="T">Todos</option>
                                            <?php $vendedor = $this->db->get_where('admin', array('status'=>1)); 
                                                foreach ($vendedor->result_array() as $vn):?>
                                            <option value="<?php echo $vn['admin_id'];?>" <?php if($vn['admin_id'] == $vendedor_id) echo "selected";?>><?php echo trim($vn['name']).' '.trim($vn['last_name']);?>
                                            </option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                            <div class="card-title">
                                <h3 class="card-label">Ventas por vendedor</h3>
                            </div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <ul class="navi flex-column navi-hover py-2">
                                            <li
                                                ...
                                                Exportar como:</li>
                                            <li class="navi-item">
                                                <a href="<?php echo base_url().'admin/export_excel/ventas_vendedor/'.$initial.'/'.$final.'/'.$vendedor_id.'/';?>"
                                                    class="navi-link">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "<?php echo base_url() . 'admin/get_ventas_vendedor/'.$initial.'/'.$final.'/'.$vendedor_id; ?>",
            type: "POST"
        },
