<?php $category_id = base64_decode($param2);
    ...
    $data = $this->db->get_where('class_product' , array('class_product_id' => $category_id))->result_array();
    foreach ($data as $row):
        $products = $this->db->get_where('products', array('class_product_id'=>$category_id))->num_rows();
?>   
...
<div class="onboarding-content with-gradient">
    <h4 class="onboarding-title" style="margin-top: 1.5rem;">Asignados a la Clase: <?php echo $row['name_class'];?></h4>
...
<script type="text/javascript" language="javascript" >  
    $(document).ready(function(){  
        var dataTable = $('#user_data').DataTable({  
            ...
            "order":[],  
            "ajax":{  
                url:"<?php echo base_url() . 'admin/get_inventario_by_class/'.$category_id; ?>",  
                type:"POST"  
            },  
            "columnDefs":[  
                {  
