...
<div class="container-fluid">
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <br><?php echo ($sale->phone) ? $sale->phone : 'Sin datos';?>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <span
                                    ...
                                    <?php if($sale->estado == 1){ echo 'Activo'; }elseif($sale->estado == 2){ echo 'Completados' ; }elseif($sale->estado == 3){echo 'Anulado';}elseif($sale->estado == 4){echo 'Cambio';} ?>
                                </span>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php echo $moneda.number_format($sale->total,2,'.',',');?>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php $restante = $sale->total - $sale->total_pagado;
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-padded">
                            ...
                            <tbody>
                                <?php $pagos = $this->db->get_where('credit_details', array('sales_id' => $sale->sales_id, 'status' => 1)); $n=1;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url()?>admin/export_pdf/pago_credito/<?php echo $pg['credit_details_id']?>" data-toggle="tooltip" data-original-title="Imprimir pago">
                        ...
                        <div class="bg-primary rounded d-flex  justify-content-between text-white position-relative ml-auto p-7">
                            ...
                            <div class="text-right d-flex flex-column">
                                <span class="font-weight-boldest font-size-h3 line-height-sm"
                                    id="total"><?php echo $moneda.number_format($sale->total_pagado,2,'.',',')?></span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    <div class="card-toolbar">
                        ...
                        <a href="<?php echo base_url().'admin/ventas';?>" style="float: right;"
                            class="btn btn-light-primary font-weight-bolder">
                            <span class="svg-icon svg-icon-md">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            <br>
            <?php if($sale->estado == 1 && ($user_type == 1 || $permisos['pagos'] == 1)): ?>
            <div class="card">
                <div class="card-body">
                    <form class="form" action="<?php echo base_url();?>admin/detalles_credito/<?php echo $code;?>/add_pay" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-xxl-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="pago" step="0.01" value="0.00" min="1" max="<?php echo $restante;?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-xxl-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="metodo" onchange="show_accounts(this.value)">
                                    ...
                                    <div class="input-group cuentas">
                                        <select class="form-control" name="account_bank" id="account_bank" required onchange="verificar()">
