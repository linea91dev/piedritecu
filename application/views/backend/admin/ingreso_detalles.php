<?php  
	$inc = $this->db->get_where('increase',array('code'=>$code))->row();
	$increase_id = $inc->increase_id;
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-toolbar">
                        <a href="<?php echo  base_url().'admin/increases/' ;?>"
                                    ...
                                    <form class="form" action="<?php echo base_url();?>admin/ingreso_detalles/"
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" class="form-control" placeholder=""
                                                aria-describedby="basic-addon2" value="<?php echo $inc->code;?>">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <span><?php echo date("d/m/Y h:i a", strtotime($inc->datetime));?></span>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label><b>Responsable:</b></label><br>
                                <?php echo $this->crud_model->getName('admin',$inc->responsable) ;?>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label><b>Destino:</b></label><br>
                                <?php echo $this->db->get_where('branch',array('branch_id'=>$inc->branch_id))->row()->name;?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-padded">
                            ...
                            <tbody>
                                <?php 
									$products = json_decode($inc->products,true); 
                        ...
                        <div
                            ...
                            <div class="text-right d-flex flex-column">
                                <span class="font-weight-boldest font-size-h3 line-height-sm"
                                    id="total"><?php echo $moneda.number_format($inc->total,2,'.',',');?></span>
                            </div>
                        </div>
                    </div>
                </div>
