<?php  
	$perd = $this->db->get_where('losse_returns',array('code'=>$code))->row();
	$perdida_id = $perd->losse_returns_id; $total = 0;
	log_message("error", "Perdida ID: $perdida_id");
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-toolbar">
                        <a href="<?php echo  base_url().'admin/perdidas/' ;?>"
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xxl-12">
                            <div class="row">
                                <div class="col-sm-12">
                                    <form class="form" action="<?php echo base_url();?>admin/ingreso_detalles/"
                                        method="POST" enctype="multipart/form-data">
                                        <br>
                                        <label>Código de pérdida:</label>
                                        <?php if($perdida_id == "" && $code != ""):?>
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" class="form-control" placeholder=""
                                                aria-describedby="basic-addon2" value="<?php echo $perd->code;?>">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <span><?php echo date("d/m/Y h:i a", strtotime($perd->datetime));?></span>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label><b>Responsable:</b></label><br>
                                <?php echo $this->crud_model->getName('admin',$perd->responsable) ;?>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label><b>Origen:</b></label><br>
                                <?php echo $this->db->get_where('branch',array('branch_id'=>$perd->branch_id))->row()->name;?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-padded">
                            ...
                            <tbody>
                                <?php $products = json_decode($perd->lotes,true); 
									foreach($products as $product): $sub = 0;
                                ...
                                <tr>
                                    ...
                                    <td class="text-center bolder"> <span
                                            class="text-success"><?php echo $moneda.number_format($product['price'],2,'.',',');?></span></td>
                                    <td class="text-right bolder"><span
                                            class="text-success"><?php echo $moneda.number_format($sub,2,'.',',') ;?></span></td>
                                </tr>
                                <?php $total += $sub; endif; endforeach; ?>
                            </tbody>
                        </table>
                    </div>
                    <hr>
