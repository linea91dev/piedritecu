<?php $moneda = $this->crud_model->get_info("moneda"); setlocale(LC_TIME, "spanish");
    $data = $this->crud_model->getVentasTraslados($initial, $final, $type);?>
                    ...
                    <div class="col-sm-12">
                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                            <div class="card-title">
                                <h3 class="card-label">Movimiento de productos</h3>
                            </div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <ul class="navi flex-column navi-hover py-2">
                                            <li class="navi-header font-weight-bolder text-uppercase font-size-sm text-primary pb-2">
                                                Exportar como:</li>
                                            <li class="navi-item">
                                                <a href="<?php echo base_url().'admin/export_excel/ventas_traslado/'.$initial.'/'.$final.'/'.$type;?>" class="navi-link">
                            ...
                            <form action="<?php echo base_url();?>admin/ventas_traslados/" method="POST">
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" name="type">
                                                    ...
                                                    <option value="Venta" <?php if($type == "Venta") echo "selected";?>>Ventas</option>
                                                    <option value="Traslado" <?php if($type == "Traslado") echo "selected";?>>Traslados</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        var dataTable = $('#user_data').DataTable({  
            ...
            "order":[],  
            "ajax":{  
                url:"<?php echo base_url() . 'admin/get_ventas_traslados/'.$initial.'/'.$final.'/'.$type.'/'; ?>",  
                type:"POST"  
            },  
            "columnDefs":[  
                {  
