<?php $data = $this->crud_model->get_sale_date($initial, $final); $moneda = $this->crud_model->get_info("moneda");?>
<style type="text/css">
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Historial de ventas
                            <span class="d-block text-muted pt-2 font-size-sm">Consulta el historial de tus ventas
                                realizadas.</span>
                        </h3>
                    </div>
                    <?php if($data->num_rows() > 0 && ($user_type == 1 || $permisos['reportes_ventas'] == 1)):?>
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <ul class="navi flex-column navi-hover py-2">
                                    <li
                                        ...
                                        Exportar como:</li>
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_excel/ventas/'.$initial.'/'.$final.'/';?>"
                                            class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_pdf/ventas/'.$initial.'/'.$final.'/';?>" class="navi-link">
                                            <span class="navi-icon">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo base_url();?>admin/ventas/">
                        <div class="row">
                            <div class="col-sm-3">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "<?php echo base_url() . 'admin/getTable/sales/'.$initial.'/'.$final.'/'; ?>",
            type: "POST"
        },
