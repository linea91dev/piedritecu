<?php $moneda = $this->crud_model->get_info("moneda"); setlocale(LC_TIME, "spanish");
    $data = $this->crud_model->get_totals_accounts_payable($initial, $final, $provider_id);
    log_message("error", "Creditos: ".$data['contador']);?>
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <form action="<?php echo base_url();?>admin/cuentas_por_pagar/" method="POST">
                        <div class="row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="provider_id" id="selected-1">
                                            <option value="T">Todos</option>
                                            <?php $provs = $this->crud_model->get_provider(); 
                                                foreach ($provs->result_array() as $pv):?>
                                            <option value="<?php echo $pv['provider_id'];?>" <?php if($pv['provider_id'] == $provider_id) echo "selected";?>><?php if($pv['nit'] != '') echo $pv['nit'].' - '; echo trim($pv['name']);?>
                                            </option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                            <div class="card-title">
                                <h3 class="card-label">Cuentas por pagar</h3>
                            </div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <ul class="navi flex-column navi-hover py-2">
                                            <li
                                                ...
                                                Exportar como:</li>
                                            <li class="navi-item">
                                                <a href="<?php echo base_url().'admin/export_excel/cuentas_pagar/'.$initial.'/'.$final.'/'.$provider_id.'/';?>"
                                                    class="navi-link">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "<?php echo base_url() . 'admin/get_cuentas_por_pagar/'.$initial.'/'.$final.'/'.$provider_id; ?>",
            type: "POST"
        },
