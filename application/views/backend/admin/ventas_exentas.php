<?php $moneda = $this->crud_model->get_info("moneda"); setlocale(LC_TIME, "spanish");
    $data = $this->crud_model->get_totals_sales_exents($initial, $final);
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <form action="<?php echo base_url();?>admin/ventas_exentas/" method="POST">
                        <div class="row">
                            <div class="col-sm-5">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                            <div class="card-title">
                                <h3 class="card-label">Ventas exentas</h3>
                            </div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <ul class="navi flex-column navi-hover py-2">
                                            <li
                                                ...
                                                Exportar como:</li>
                                            <li class="navi-item">
                                                <a href="<?php echo base_url().'admin/export_excel/ventas_exentas/'.$initial.'/'.$final.'/';?>"
                                                    class="navi-link">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "<?php echo base_url() . 'admin/get_ventas_exentas/'.$initial.'/'.$final.'/'; ?>",
            type: "POST"
        },
