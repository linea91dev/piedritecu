...
<div class="container-fluid">
    <form class="form" action="<?php echo base_url();?>admin/add_stock/" method="POST" enctype="multipart/form-data" id='compraForm' name='compraForm'>
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 col-xxl-12">
                                <span>Código de entrada: <b><?php echo $code;?></b></span>
                ...
                <div class="card ">
                    <div class="card-body">
                            ...
                            <table class="table table-padded">
                                <thead>
                                    <tr>
                                        ...
                                        <th class='text-center'>Costo (<?php echo $moneda;?>)</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-rounded btn-success">Registrar</button>
                            </div>
                        </div>
                    </div>
                </div>
