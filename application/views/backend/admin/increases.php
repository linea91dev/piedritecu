<?php 
    $data = $this->crud_model->get_increases_details($initial,$final); 
    $moneda = $this->crud_model->get_info("moneda");
    $tipo = $this->session->userdata('login_user_type');
    $total = $this->crud_model->get_increases_total($initial, $final);
?>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card card-custom">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <ul class="navi flex-column navi-hover py-2">
                                    <li class="navi-header font-weight-bolder text-uppercase font-size-sm text-primary pb-2">
                                        Exportar como:</li>
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_pdf/increase/'.$initial.'/'.$final?>" class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_pdf/increase_details/'.$initial.'/'.$final?>" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="la la-file-pdf-o"></i>
                                            </span>
                                    ...
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_excel/increase_details/'.$initial.'/'.$final?>" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="la la-file-excel-o"></i>
                                            </span>
                                            <span class="navi-text">Detalles Excel</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo base_url();?>admin/increases/">
                        <div class="row">
                            <div class="col-sm-3">
