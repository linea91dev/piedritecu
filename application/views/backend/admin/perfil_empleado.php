<?php $data = $this->db->limit(1)->get_where('admin', array('admin_id'=>$ID)); ?>
                    ...
                    <div class="card-title">
                        <h3 class="card-label">Perfil de usuario
                            <span class="d-block text-muted pt-2 font-size-sm">Para evitar problemas de comunicación
                                entre el sistema y tú, mantén tus datos actualizados.</span>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        <a href="<?php echo  base_url().'admin/empleados/' ;?>" class="btn btn-light-primary font-weight-bolder">
                        ...
                        <?php if($user_type == 1 || $permisos['reportes_empleados'] == 1):?>
                        <a href="<?php echo base_url().'admin/export_pdf/empleado/'.$ID;?>"
                            target="_blank" class="btn btn-primary font-weight-bolder">
                            <i class="fas fa-print"></i> Imprimir PDF
                        </a>&nbsp;&nbsp;
                        <?php endif;?>
                        <a href="javascript:;" onclick="executeExample('<?php echo $ID;?>')" class="btn btn-light-danger font-weight-bolder">
                ...
                <div class="card-body">
                    <div class="mb-7">
                        <div class="row align-items-center">
                            <form class="form" action="<?php echo base_url().'admin/admins/update/'.$data->row()->admin_id.'/2';?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Celular</label>
                                            <div class="input-group">
                                                <input type="number" oninput="if(value.length>8)value=value.slice(0,8)" class="form-control" aria-label="Text input with checkbox" min='0' value='<?php echo $row['phone'];?>' name='phone' />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="tel" class="form-control" name="emergency_phone"
                                                    ...
                                                    value="<?php echo htmlspecialchars($row['emergency_phone'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                                                    placeholder="55555555" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="account_number"
                                                    ...
                                                    value="<?php echo htmlspecialchars($row['account_number'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="bank_reference"
                                                    maxlength="100"
                                                    value="<?php echo htmlspecialchars($row['bank_reference'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" aria-label="Text input with checkbox" value='<?php echo $row['username'];?>' name='username' required disabled />
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="kt_datepicker" aria-label="Text input with checkbox" required name='birthday' readonly placeholder="dd/mm/aaaa" value='<?php echo (!empty($row['birthday']) && $row['birthday'] != '0000-00-00') ? date('d/m/Y', strtotime($row['birthday'])) : '';?>' />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="kt_datepicker_1" aria-label="Text input with checkbox" name='hiring' readonly placeholder="dd/mm/aaaa" value='<?php echo (!empty($row['hiring']) && $row['hiring'] != '0000-00-00') ? date('d/m/Y', strtotime($row['hiring'])) : '';?>' />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="job" class="form-control" required>
                                                <?php $rol = $this->db->get_where('job', array('status'=>1))->result_array(); 
                                                    foreach($rol as $r):?>
                                                <option value="<?php echo $r['job_id'];?>" <?php echo ($row['job']==$r['job_id']) ? 'selected':'' ;?>>
                                                    <?php echo $r['name']; ?>
                                                </option>
                                                <?php endforeach ;?>
                                            </select>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>Salario</label>
                                            <div class="input-group">
                                                <input type="number" class="form-control" aria-label="Text input with checkbox" min="0" step="0.01" value="<?php echo $row['salary'];?>" name="salary" />
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" aria-label="Text input with checkbox"
                                                    name="bonus" min="0" step="0.01" value="<?php echo $row['bonus'];?>"/>
                                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" aria-label="Text input with checkbox"
                                                    name="complemento" min="0" step="0.01" value="<?php echo isset($row['complemento']) ? $row['complemento'] : 0;?>"/>
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="password" class="form-control" placeholder='Ingresa tu contraseña actual' aria-label="Text input with checkbox" name='password' id="password" onkeyup="comparar_pass()" />
                                            </div>
                                            <label id="mensgg" class="control-label text-danger" style="display: block;">
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <?php if($user_type == 1 || $permisos['editar_empleados'] == 1):?>
                                    <div class="col-sm-12">
        ...
        <div class="col-xl-4">
            <div class="card card-custom">
                <div class="card-body">
                    <div class="mb-7">
                        <div class="row align-items-center">
                            <h4><a href="<?php echo base_url().'admin/actividad/'.$ID;?>"> Actividades </a>
                            </h4>
                            <?php $actividades = $this->db->limit(10)->order_by('binnacle_id', 'DESC')->get_where('binnacle', array('user_id'=>$ID)); if($actividades-> num_rows()>0): foreach ($actividades->result_array() as $ac):?>
                            <div class="col-sm-12">
...
function SHA1(msg) {
    ...
    for (blockstart = 0; blockstart < word_array.length; blockstart += 16) {
        ...
        for (i = 40; i <= 59; i++) {
            temp = (rotate_left(A, 5) + ((B &
                C) | (B & D) | (C & D)) + E + W[i] + 0x8F1BBCDC) & 0x0ffffffff;
            E = D;
            D = C;
            C = rotate_left(B, 30);
            B = A;
...
function executeExample(_id) {
    Swal.fire({
        ...
        if (result.value) {
            ...
            location.href = "<?php echo base_url();?>admin/admins/credenciales/" + _id;
        }
    })
}
</script>
