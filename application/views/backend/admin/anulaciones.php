<?php $data = $this->crud_model->get_anulations(); $moneda = $this->crud_model->get_info("moneda");?>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Ventas anuladas
                            <span class="d-block text-muted pt-2 font-size-sm">Consulta el historial de tus ventas
                                anuladas.</span>
                        </h3>
                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <ul class="navi flex-column navi-hover py-2">
                                    <li
                                        ...
                                        Exportar como:</li>
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_excel/anulaciones';?>"
                                            class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_pdf/anulaciones';?>"
                                            class="navi-link">
                                            <span class="navi-icon">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-3 mb-lg-0 mb-6">
                                ...
                                <input type="text" class="form-control datatable-input" id="kt_datepicker"
                                    placeholder="mm/dd/aaaa" readonly data-col-index="1">
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            ...
                                            <?php if($row['estado'] == 1){ echo 'Activo'; }elseif($row['estado'] == 2){ echo 'Completados' ; }elseif($row['estado'] == 3){echo 'Anulado';} ?>
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex flex-shrink-0">
                                            <?php if($row['estado'] != 3  && ($user_type == 1 || $permisos['editar_anulaciones'] == 1)):?>
                                            &nbsp;
                                            ...
                                            &nbsp;
                                            <?php if($user_type == 1 || $permisos['reportes_anulaciones'] == 1):?>
                                            ...
                                            <?php endif;?>
                                            &nbsp;
                                            <?php /* if($user_type == 1 || $permisos['eliminar_anulaciones'] == 1):?>
