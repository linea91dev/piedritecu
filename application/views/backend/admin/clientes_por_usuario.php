<?php $moneda = $this->crud_model->get_info("moneda"); setlocale(LC_TIME, "spanish");
    $data = $this->crud_model->get_totals_clients_user($initial, $final);
    log_message("error", "Clientes: ".$data['contador']);?>
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <form action="<?php echo base_url();?>admin/clientes_por_usuario/" method="POST">
                        <div class="row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="usuario_id" id="selected-1">
                                            <option value="T" <?php if($usuario_id == '') echo "selected";?>>Todos</option>
                                            <?php $usuarios = $this->db->get_where('admin', array('status'=>1)); 
                                                foreach ($usuarios->result_array() as $u):?>
                                            <option value="<?php echo $u['admin_id'];?>" <?php if($u['admin_id'] == $usuario_id) echo "selected";?>><?php echo trim($u['name']).' '.trim($u['last_name']);?>
                                            </option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                            <div class="card-title">
                                <h3 class="card-label">Clientes por usuario</h3>
                            </div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <ul class="navi flex-column navi-hover py-2">
                                            <li
                                                ...
                                                Exportar como:</li>
                                            <li class="navi-item">
                                                <a href="<?php echo base_url().'admin/export_excel/clientes_por_usuario/'.$initial.'/'.$final.'/';?>"
                                                    class="navi-link">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "<?php echo base_url() . 'admin/get_clientes_por_usuario/'.$initial.'/'.$final.'/'.$usuario_id; ?>",
            type: "POST"
        },
