<?php $category_id = base64_decode($param2);
    ...
    $data = $this->db->get_where('type_product' , array('type_product_id' => $category_id))->result_array();
    foreach ($data as $row):
        $products = $this->db->get_where('products', array('type_product_id'=>$category_id))->num_rows();
?>   
...
<div class="onboarding-content with-gradient">
    <h4 class="onboarding-title" style="margin-top: 1.5rem;">Asignados a la categoria: <?php echo $row['name'].$category_id;?></h4>
...
<script type="text/javascript" language="javascript" >  
    $(document).ready(function(){  
        var dataTable = $('#user_data').DataTable({  
            ...
            "order":[],  
            "ajax":{  
                url:"<?php echo base_url() . 'admin/get_inventario_by_type/'.$category_id; ?>",  
                type:"POST"  
            },  
            "columnDefs":[  
                {  
