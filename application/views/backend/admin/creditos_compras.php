<?php $data = $this->crud_model->get_shopping_credit(); $moneda = $this->crud_model->get_info("moneda");?>
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <ul class="navi flex-column navi-hover py-2">
                                    <li
                                        ...
                                        Exportar como:</li>
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_excel/compras';?>"
                                            class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_pdf/compras';?>" class="navi-link">
                                            <span class="navi-icon">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-3 mb-lg-0 mb-6">
                                ...
                                <div class="input-daterange input-group">
                                    <input type="text" class="form-control datatable-input" 
                                        autocomplete="off" placeholder="VC1234" data-col-index="1">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 mb-lg-0 mb-6">
                                ...
                                <div class="input-daterange input-group" id="kt_datepicker">
                                    <input type="text" class="form-control datatable-input" name="start" readonly="readonly"
                                        autocomplete="off" placeholder="dd/mm/aaaa" data-col-index="2">
                                </div>
                            </div>
                        ...
                        <table class="table table-bordered dataTable no-footer dtr-inline" id="kt_datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th title="Field #4">Fecha</th>
                                    <th title="Field #5">Total</th>
                                    <th title="Field #6">Estado</th>
                                    <th title="Field #7">Credito</th>
                                    <th title="Field #8">Encargado</th>
