                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Alerta de inventario
                            <span class="d-block text-muted pt-2 font-size-sm">Administra tus productos próximos a vencer.</span>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        ...
                        <a href="<?php echo base_url().'admin/alertas'?>" class="btn btn-light-primary font-weight-bold mr-2"> 
                        <span class="svg-icon svg-icon-md">
                        ...
                        <table class="table table-bordered dataTable no-footer dtr-inline" id="kt_datatable">
                            ...
                            <tbody id='table'>
                                <?php 
									...
									if($fecha_vencimiento > '0000-00-00'  && $diff->days < $this->db->get_where('settings', array('type'=>'vencimiento'))->row()->description):
								?>
                                <tr>
                                    <td><?php echo $n++;?></td>
                                    ...
                                    <td>
                                        ...
                                        $Nueva_Fecha = date("d-m-Y", strtotime( $fecha_vencimiento ));				
