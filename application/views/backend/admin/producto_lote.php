    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Gestionar inventario
                            <span class="d-block text-muted pt-2 font-size-sm">Administra tus productos en inventario.</span>
                        </h3>
                    </div>
                ...
                <div class="card-body">
                    <form class="form" action="<?php echo base_url();?>admin/producto_lote/create" method="POST"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group text-center">
                                    <div class="col-lg-12 col-xl-12">
                                        <div class="image-input image-input-outline" id="kt_profile_avatar"
                                            ...
                                            <?php $img = $this->db->get_where('products',array('products_id' => $ID))->row()->img;
                                            if ($img == ""):?>
                                            <div class="image-input-wrapper"
                                                style="background-image: url(<?php echo base_url().'uploads/productos/default_product.png'; ?>);background-size:contain;background-position:center;">
                                            </div>
                                            <?php else:?>
                                            <div class="image-input-wrapper"
                                                style="background-image: url(<?php echo base_url().'uploads/productos/'.$img; ?>);background-size:contain;background-position:center;">
                                            </div>
                                            <?php endif; ?>
                                            <span
                                                class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                                data-action="cancel" data-toggle="tooltip" title="Cancelar cambio">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input disabled type="text" class="form-control"
                                            ...
                                            value="<?php echo $this->db->get_where('products',array('products_id' => $ID))->row()->name;?>" />
                                        <input type="hidden" name='products_id' required value="<?php echo $ID;?>" />
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input disabled type="text" class="form-control"
                                            aria-label="Text input with checkbox" placeholder="FDF34FS" name='code'
                                            maxlength="6" required
                                            value="<?php echo $this->db->get_where('products',array('products_id' => $ID))->row()->code;?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-inline text-center">
                                        <label class="checkbox checkbox-rounded">
                                            <input type="radio" checked name="branch_id"
                                                value='<?php echo $this->session->userdata('branch_id');?>'>
                                            <span></span>Inventario
                                        </label>
                                        <label class="checkbox checkbox-rounded">
                                            <input type="radio" name="branch_id" value='0'>
                                            <span></span>Bodega
                                        </label>
                                    </div>
                                </div>
