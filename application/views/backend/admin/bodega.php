            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Gestionar bodega
                    ...
                    <div class="card-toolbar">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <ul class="navi flex-column navi-hover py-2">
                                    <li class="navi-header font-weight-bolder text-uppercase font-size-sm text-primary pb-2">
                                        Exportar como:</li>
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_excel/bodega'?>" class=" navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_pdf/bodega'?>" class="navi-link">
                                            <span class="navi-icon">
                        ...
                        <?php endif;?>
                        <a href="<?php echo base_url();?>admin/nuevo_producto/2" class="btn btn-primary font-weight-bolder">
                            <span class="svg-icon svg-icon-md">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-4 my-2 my-md-0">
                                        <div class="input-icon">
                                            <input type="text" class="form-control" placeholder="Buscar..." id="name" onkeyup="search()" />
                                            <span><i class="flaticon2-search-1 text-muted"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4 my-2 my-md-0">
                                        <div class="d-flex align-items-center">
                                            <label class="mr-3 mb-0 d-none d-md-block">Proveedores:</label>
                        ...
                        <table class="table table-bordered dataTable no-footer dtr-inline" id="kt_datatable">
                            ...
                            <tbody id='table'>
                                ...
                                <tr>
                                    ...
                                    <td><span class="text-success"><b><?php echo $this->crud_model->get_stock($row['products_id'],0);?></b></span></td>
                                    <td><?php echo ($row['variantes']==1) ? 'Si':'No' ;?></td>
                                    <td><?php echo $moneda.number_format($row['price'],'2','.', ',');?></td>
                                    <td><?php echo $moneda.number_format($row['cost'],'2','.', ',');?></td>
                                    <td>
                                        <div class="d-flex flex-shrink-0">
                                            &nbsp;
                                            <a href="<?php echo base_url().'admin/editar_producto/'.$row['products_id'];?>" data-toggle="tooltip" data-original-title="Editar bodega" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            &nbsp;
                                            <a href="javascript:;" data-toggle="tooltip" data-original-title="Eliminar bodega" onclick="executeExample('<?php echo $row['products_id'];?>')" class="btn btn-icon btn-bg-light btn-active-color-info btn-sm">
...
function search() {
    ...
    $.ajax({
        type: "POST",
        url: '<?php echo base_url();?>admin/search/bodega',
        data: {
            name: $name,
            status: $status,
        },
...
function executeExample(_id) {
    Swal.fire({
        title: '¿Estás seguro?',
        text: "Se eliminará toda la información del producto!",
        icon: 'info',
        ...
        if (result.value) {
            ...
            location.href = "<?php echo base_url();?>admin/nuevo_producto/delete/" + _id;
        }
    })
}
</script>
