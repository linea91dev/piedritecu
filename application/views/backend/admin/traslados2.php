...
//print_r($data);
    log_message("error", "Id branch: $id_branch, Date: $date");
?>
        ...
        <div class="col-xl-12">
            <div class="card card-custom">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <ul class="navi flex-column navi-hover py-2">
                                    <li
                                        ...
                                        Exportar como:</li>
                                    <li class="navi-item">
                                        <a href="<?php echo base_url().'admin/export_excel/transfers/'.$initial.'/'.$final?>"
                                            class="navi-link">
                ...
                <div class="card-body">
                    ...
                    <form class="mb-15" method="POST" action="<?php echo base_url().'admin/traslados/encabezado/'?>">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-3 mb-lg-0 mb-6">
                                ...
                                <select class=" form-control datatable-input" name="id_branch">
                                    <option value="">Todas</option>
                                    <option value="0" <?php if($id_branch == '0') echo "selected";?>>Bodega</option>
                                    <?php $sucursales = $this->db->get_where('branch',array('status'=>1))->result_array(); foreach ($sucursales as $sc):?>
                                    <option value="<?php echo $sc['branch_id'];?>" <?php if($sc['branch_id'] == $id_branch) echo "selected";?>><?php echo $sc['name'];?></option>
                                    <?php endforeach?>
                                </select>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered dataTable no-footer dtr-inline" id="kt_datatable_1">
                            <thead>
                                <tr>
                                    <!-- <th style="display:none;">ID traslado</th>-->
                                    <th>ID</th>
                                    <th>Fecha</th>
                                    <th>Desde</th>
                                    <th>Hacia</th>
                            ...
                            <tbody id='table'>
                                ...
                                <tr>
                                    <!-- <td style="display:none;"><?php echo $row['id_traslado'];?></td> -->
                                    <td><?php echo $row['code_traslado'];?></td>
                                    ...
                                    <td>
                                        <span class="label label-lg font-weight-bold label-light-danger label-inline">
                                            Se envio de: <?php echo $row['Desde'] == 0 ? "Bodega": $this->db->get_where('branch',array('branch_id'=>$row['Desde']))->row()->name;?>
                                        </span>
                                    </td>
                                    <td>
                                        <span class="label label-lg font-weight-bold label-light-success label-inline">
                                            Se recibio en: <?php echo $row['Hacia'] == 0 ? "Bodega": $this->db->get_where('branch',array('branch_id'=>$row['Hacia']))->row()->name;?>
                                        </span>                                          
                                    </td>
                                    <td><span
                                            class="text-<?php echo"success";?>"><b><?php echo $row['cantidad_prod'];?></b></span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex flex-shrink-0">
                                            ...
                                            &nbsp;
                                            <a href="<?php echo base_url();?>admin/traslados_detalle/<?php echo $row['id_traslado'];?>"
                                                class="btn btn-icon btn-bg-light btn-active-color-info btn-sm"
