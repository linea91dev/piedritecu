...
<html>
    ...
    <?php $branch_id = $this->session->userdata("branch_id");
        $data = $this->db->get_where('losse_returns', array('losse_returns_id'=>$losse_return_id))->row_array();?>
    <body>
        ...
        <main>
            <div style="width:100%; font-size: 16px; line-height: 24px; font-family: 'nunito'; color: #555;">
                    ...
                    <tr>
                        <td colspan="2">
                            <table style="width: 100%;line-height: inherit;text-align: left;">
                                ...
                                <tr style="">
                                    <td style="padding-top:15px;padding-bottom: 15px;">
                                        <b style="font-size: 12px;">Código de transacción:
                                            <span><?php echo $data['code'];?></span></b><br>
                                        <b style="font-size: 12px;">Registrado por:
                                            <span><?php echo $this->crud_model->getName('admin', $data['responsable']);?></span></b>
                                        <p style="font-size: 12px;">Fecha: <b><small
                                                    style="font-weight:bold; text-transform:uppercase"><?php echo date('d/m/Y H:i a', strtotime($data['datetime']));?></small></b>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                ...
                <table cellpadding="0" cellspacing="0"
                    ...
                    <?php $rows = json_decode($data['lotes'], true); $n=1; $moneda = $this->crud_model->get_info("moneda");
                        $total = 0; $sub = 0;
