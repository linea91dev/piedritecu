...
<?php ini_set("memory_limit","500M");
    $data = $this->db->get_where('increase', array('increase_id'=>$increase_id))->row_array();
        ...
        <main>
            <div style="width:100%; font-size: 16px; line-height: 24px; font-family: 'nunito'; color: #555;">
                            ...
                            <table style="width: 100%;line-height: inherit;text-align: left;">
                                <tr>
                                    ...
                                    <td style="padding-bottom: 20px; vertical-align: top;text-align:center;padding-top:5px;">
                                        <p></p>
                                        <p style="text-transform:uppercase"><b><u>Reporte de inventario</u></b></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr style="">
                                    <td style="padding-top:15px;padding-bottom: 15px;">
                                        ...
                                        <b style="font-size: 12px;">Registrado por:
                                            <span><?php echo $this->crud_model->getName('admin', $data['responsable']);?></span></b><br>
                                        <b style="font-size: 12px;">Total:
                                            <span><?php echo $moneda.number_format($data['total']);?></span></b>
                                        <p style="font-size: 12px;">Fecha: <b><small
                ...
                <table cellpadding="0" cellspacing="0"
                    ...
                    <?php $rows = json_decode($data['products']); $n=1; $moneda = $this->crud_model->get_info("moneda");
                        $total = 0;
                        for($i=0; $i<$data['num_products'];$i++):
                            $prod = $this->db->get_where('products', array('products_id'=>$rows[$i]->product))->row_array();
                        ?>
                    <tr>
                        <td colspan="3"
                        ...
                        <td style="padding:15px;font-size: 12px;border-left: 1px solid black;border-top: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;text-align:center"
                            colspan="4">
                            <?php echo $rows[$i]->amount;?>
                        </td>
                        <td style="padding:15px;font-size: 12px;border-left: 1px solid black;border-top: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;text-align:center"
                            colspan="4">
                            <?php echo $moneda.number_format($rows[$i]->price_buy,2,'.',',');?>
                        </td>
                        <td style="padding:15px;font-size: 12px;border-left: 1px solid black;border-top: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;text-align:center"
                            colspan="4">
                            <?php echo $moneda.number_format($rows[$i]->sub,2,'.',',');?>
                        </td>
                    </tr>
                    <?php endfor;?>
                </table>
