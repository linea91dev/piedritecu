...
<html>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <link rel="shortcut icon" href="https://mayansource.dev/msbox/public/assets/media/logos/Isologo.png" />
            ...
            <div class="row">
                <div class="col-sm-6" style="float: none; margin: 0 auto;">
                    <form action="<?php echo base_url();?>installer/install" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="type_install" value="1">
                        <div class="row">
                            <div class="col-sm-12">
                                <?php if(isLocalhost()):?>
                            ...
                            <div class="col-sm-12"><br>
                                ...
                                <label class="bold">ACCESO A LA BASE DE DATOS</label><br><br>
                            </div>
                            <div class="col-sm-6">
