...
//	});
	...
	function ApndImgEmotion() {
		for (var i = 65; i <= 70; i++) {
			$('.emotion-area').append(
				'<img width="30px" height="30px" src="http://localhost/educaby/assets/img/1f60' + String.fromCharCode(i).toLowerCase() + '.png">' + 
				'<img width="30px" height="30px" src="http://localhost/educaby/img/1f61' + String.fromCharCode(i).toLowerCase() + '.png">' + 
				'<img width="30px" height="30px" src="http://localhost/educaby/img/1f62' + String.fromCharCode(i).toLowerCase() + '.png">' + 
				'<img width="30px" height="30px" src="http://localhost/educaby/img/1f47' + String.fromCharCode(i).toLowerCase() + '.png">' +
				'<img width="30px" height="30px" src="http://localhost/educaby/img/1f49' + String.fromCharCode(i).toLowerCase() + '.png">'
			);
		}
