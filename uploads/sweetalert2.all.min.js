!(function (e, t) {
	...
	var t = "SweetAlert2:",
		...
		Y = function () {
			var e = p(w().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(
					function (e, t) {
						return (
		...
		$ = function (e) {
			...
			if (
				...
				r.setAttribute("role", e.toast ? "alert" : "dialog"),
					...
					"rtl" === window.getComputedStyle(o).direction && D(b(), I.rtl);
				var m = function (e) {
					Le.isVisible() && i !== e.target.value && Le.resetValidationMessage(),
						(i = e.target.value);
				};
				return (
					(s.oninput = m),
		...
		G = function (e) {
			var t = F(),
				...
				o = L();
			if (
				(e.showConfirmButton || e.showCancelButton ? z(t) : W(t),
				e.showCancelButton ? (o.style.display = "inline-block") : W(o),
				e.showConfirmButton ? n.style.removeProperty("display") : W(n),
				...
				D(n, e.confirmButtonClass),
				(o.className = I.cancel),
				D(o, e.cancelButtonClass),
				e.buttonsStyling)
			) {
				D([n, o], I.styled),
				...
				var i = window.getComputedStyle(n).getPropertyValue("backgrou nd-color");
		...
		oe = function (i) {
			var r = A(),
				a = parseInt(
					null === i.currentProgressStep ? Le.getQueueStep() : i.currentProgressStep,
					10
				);
				...
				? (z(r),
				  ...
				  i.progressSteps.forEach(function (e, t) {
						...
						if (
							(D(n, I["progress-step"]),
							(n.innerHTML = e),
							t === a && D(n, I["active-progress-step"]),
							r.appendChild(n),
	...
	var re = [],
		...
		me = { promise: new WeakMap(), innerParams: new WeakMap(), domCache: new WeakMap() };
	function ge() {
		var e = me.innerParams.get(this),
			t = me.domCache.get(this);
		e.showConfirmButton || (W(t.confirmButton), e.showCancelButton || W(t.actions)),
		...
		if (n) {
			...
			var s = function () {
				T()
					...
					: (new Promise(function (e) {
							...
							(se.restoreFocusTimeout = setTimeout(function () {
								se.previousActiveElement && se.previousActiveElement.focus
									? (se.previousActiveElement.focus(), (se.previousActiveElement = null))
					...
					U(
						[document.documentElement, document.body],
						[I.shown, I["height-auto"], I["no-backdrop"], I["toast-shown"], I["toast-column"]]
					),
					E() &&
						(null !== m.previousBodyPadding &&
						...
						"undefined" != typeof window && be() && window.removeEventListener("resize", ve),
	...
	var Be = function (e) {
		...
		null !== e.onBeforeOpen && "function" == typeof e.onBeforeOpen && e.onBeforeOpen(n),
			e.animation ? (D(n, I.show), D(t, I.fade), U(n, I.hide)) : U(n, I.fade),
			z(n),
			...
			E() &&
				...
				"undefined" != typeof window && be() && (ve(), window.addEventListener("resize", ve)),
				p(document.body.children).forEach(function (e) {
					e === b() ||
						(function (e, t) {
			...
			T() || se.previousActiveElement || (se.previousActiveElement = document.activeElement),
			null !== e.onOpen &&
	...
	var Ae,
		Pe = Object.freeze({
			...
			setProgressSteps: function (e) {
				var t = s({}, me.innerParams.get(this), { progressSteps: e });
			...
			_main: function (e) {
				...
				!(function (e) {
					for (var t in e)
						de(t) || q('Unknown parameter "'.concat(t, '"')),
							e.toast &&
								-1 !== le.indexOf(t) &&
				...
				!(function (t) {
					...
					(e = n && o && n.parentNode !== o.parentNode ? $(t) : n || $(t)),
						t.width && (e.style.width = "number" == typeof t.width ? t.width + "px" : t.width),
						null !== t.padding &&
							(e.style.padding = "number" == typeof t.padding ? t.padding + "px" : t.padding),
						t.background && (e.style.background = t.background);
					for (
						var i = window.getComputedStyle(e).getPropertyValue("backgrou nd-color"),
					...
					if (
						...
						"string" == typeof t.backdrop
							...
							: t.backdrop || D([document.documentElement, document.body], I["no-backdrop"]),
						!t.backdrop &&
							t.allowOutsideClick &&
					...
					t.showCloseButton ? (c.setAttribute("aria-label", t.closeButtonAriaLabel), z(c)) : W(c),
						(e.className = I.popup),
						t.toast
							? (D([document.documentElement, document.body], I["toast-shown"]), D(e, I.toast))
							: D(e, I.modal),
						t.customClass && D(e, t.customClass),
						t.customContainerClass && D(s, t.customContainerClass),
						oe(t),
						te(t),
						ne(t),
						G(t),
						J(t.footer, u),
						!0 === t.animation ? U(e, I.noanimation) : D(e, I.noanimation),
				...
				return new Promise(function (e) {
					...
					ye.swalPromiseResolve.set(E, e),
						T.timer &&
							(se.timeout = new ke(function () {
													...
													? (E.disableInput(),
													  Promise.resolve()
															...
															.then(function (e) {
																E.enableButtons(),
																	E.enableInput(),
																	e ? E.showValidationMessage(e) : c(a);
															}))
							...
							(O.container.onmousedown = function () {
								O.popup.onmouseup = function (e) {
									(O.popup.onmouseup = void 0),
										(e.target === O.popup || O.popup.contains(e.target)) && (r = !0);
								};
							}),
					...
					T.reverseButtons
						? O.confirmButton.parentNode.insertBefore(O.cancelButton, O.confirmButton)
						: O.confirmButton.parentNode.insertBefore(O.confirmButton, O.cancelButton);
					var a = function (e, t) {
						for (var n = Y(T.focusCancel), o = 0; o < n.length; o++)
					...
					se.keydownHandlerAdded &&
						...
						T.toast ||
									...
									if (
										...
										if ("Tab" === e.key) {
											...
											[
												...
												? document.activeElement === O.confirmButton && K(O.cancelButton)
													? O.cancelButton.focus()
													: document.activeElement === O.cancelButton &&
													  K(O.confirmButton) &&
													  O.confirmButton.focus()
												: ("Escape" !== e.key && "Esc" !== e.key) ||
												  !0 !== H(t.allowEscapeKey) ||
												  (e.preventDefault(), s(M.DismissReason.esc));
									else if (
										e.target &&
										E.getInput() &&
										e.target.outerHTML === E.getInput().outerHTML
									) {
							...
							(se.keydownTarget = T.keydownListenerCapture ? window : O.popup),
							(se.keydownListenerCapture = T.keydownListenerCapture),
					...
					for (
						var u,
							l,
							d = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
							p = function (e) {
						...
						if ((u = E.getInput(d[f]))) {
							...
							for (var v in T.inputAttributes)
								("range" === d[f] && "placeholder" === v) ||
									u.setAttribute(v, T.inputAttributes[v]);
						}
					...
					switch (T.input) {
						...
						case "select":
							...
							if (((k.innerHTML = ""), T.inputPlaceholder)) {
								...
								(x.innerHTML = T.inputPlaceholder),
									(x.value = ""),
									(x.disabled = !0),
									(x.selected = !0),
									k.appendChild(x);
					...
					if ("select" === T.input || "radio" === T.input) {
						...
						-1 !== ["text", "email", "number", "tel", "textarea"].indexOf(T.input) &&
							...
							T.inputValue
								.then(function (e) {
									(u.value = "number" === T.input ? parseFloat(e) || 0 : e + ""),
										z(u),
										u.focus(),
										E.hideLoading();
								})
								.catch(function (e) {
									j("Error in inputValue promise: " + e),
										(u.value = ""),
										z(u),
										u.focus(),
										E.hideLoading();
